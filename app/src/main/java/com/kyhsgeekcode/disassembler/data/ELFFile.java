...
import com.kyhsgeekcode.disassembler.data.Rela;
...
public class ELFFile extends AbstractFile {
    Elf elf;
    String info = "";
    /*
    ...
    public ELFFile(File file, byte[] filec) throws IOException {
        elf = new Elf(file);
...
//	}
	/*
	 public ELFFile(File file) throws Exception
	 {
	 ...
	 public ELFFile(byte[] bytes) throws Exception
	 {
	 ...
	 */
	 ...
	 /*
	 public ELFFile(FileChannel channel, byte[] filec) throws IOException
	 {
	 super(null);
	 elf = new Elf(channel);
	 fileContents = filec;
