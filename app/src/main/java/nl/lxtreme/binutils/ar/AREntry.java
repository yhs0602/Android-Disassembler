...
public class AREntry {
     ...
     * archive.
     *
     * @param aArchive the archive to read the header for;
     * @param aFile    the file of the archive to read the header from.
     ...
     *
     * @param aIdent the byte array with the possible AR header.
