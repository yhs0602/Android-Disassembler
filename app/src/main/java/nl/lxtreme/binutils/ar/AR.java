...
public class AR {
     ...
     *
     * @param aFile The AR archive file to process.
     * @throws IllegalArgumentException in case the given file was <code>null</code>;
     * @throws IOException              if the given file is not a valid AR archive.
     */
     ...
     *
     * @param aOutputDir the output directory to extract the files to, cannot be
     *                   <code>null</code>;
     * @param aNames     the names of the files to extract, if omitted all files will be
     *                   extracted.
     * @throws IllegalArgumentException in case the given output directory was <code>null</code>;
     ...
     * @throws IOException Unable to process the archive file.
     * @see AREntry
     */
     ...
     *
     * @param aWriter the writer to write the file contents to, cannot be
     *                <code>null</code>;
     * @param aName   the name of the file to read, cannot be <code>null</code>.
     * @return <code>true</code> if the file was successfully read,
     * <code>false</code> otherwise.
     * @throws IllegalArgumentException in case either one of the given arguments was <code>null</code>;
     * @throws IOException              in case of I/O problems.
     */
     ...
     *
     * @param aOffset Offset into the string table for first character of the name.
     * @throws IOException <code>offset</code> not in string table bounds.
     */
     ...
     *
     * @param aEntry the entry to extract;
     * @param aFile  the file to write the entry data to.
     * @throws IOException in case of I/O problems.
     */
     ...
     *
     * @param aEntry  the entry to extract;
     * @param aWriter the {@link Writer} to write the entry data to.
     * @throws IOException in case of I/O problems.
     */
     ...
     *
     * @param aSet     the set of strings to search;
     * @param aSubject the subject to search for.
